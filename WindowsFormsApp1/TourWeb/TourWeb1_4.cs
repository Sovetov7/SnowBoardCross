...
{
    public partial class TourWeb1_4 : Form
    {
        ...
        public TourWeb1_4(string state)
        {
            InitializeComponent();
            this.state = state;
            if (state == "begin")
            {
                ...
                string result;
                DataGridView[] dataGridViews = new DataGridView[4]
                {
            ...
            {
                string result;
                DataGridView[] dataGridViews = new DataGridView[4]{GridRace1, GridRace2, GridRace3, GridRace4};
                for (int i = 0; i < groups; i++)
                {
                    result = SwitchDataGrid(dataGridViews[i], "fill");
                    if (result == "error") break;
